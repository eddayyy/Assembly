...
g++ -c -m64 -Wall -std=c++17 -fno-pie -no-pie -o display.o display.cpp -g

echo "Compile the C file main.c"
gcc -c -Wall -m64 -no-pie -o main.o main.c -std=gnu11 -lm -g

echo "Link the three files display.o driver2.o compute_time.o"
g++ -m64 -std=c++17 -fno-pie -no-pie -o output.out display.o manager.o input_array.o main.o sum.o -g
